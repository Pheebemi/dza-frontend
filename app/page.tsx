    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      >
        <Container maxWidth="sm">
          ...
          <Typography variant="h2" fontWeight={700} mt={1} mb={1}>
            Mwambwi
          </Typography>
      ...
      <Box component="section" sx={{ bgcolor: '#FFFDE7', py: 7, px: 3 }}>
        <Container maxWidth="sm">
          <Typography variant="h6" align="center" color="primary" fontWeight={700} mb={3}>
            A taste of Jenjo
          </Typography>
      ...
      <Box
        component="footer"
        sx={{ bgcolor: 'primary.main', color: '#a5d6a7', textAlign: 'center', py: 2 }}
      >
